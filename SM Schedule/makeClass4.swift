...
class makeClass4: UIViewController {
    ...
    let classTextField: UITextField = {
        let tf = UITextField()
        tf.placeholder = "Enter Orange Class"
    ...
    func handleNext(){
        ...
        let class4 = classTextField.text
        let class4Location = locationTextField.text
        if class4 != nil && class4Location != nil {
            ref.child("classes").child("class4").setValue(class4)
            ref.child("locations").child("class4").setValue(class4Location)
            presentViewController(makeClass5(), animated: true, completion: nil)
        }else {
            print("invalid class")
        }
